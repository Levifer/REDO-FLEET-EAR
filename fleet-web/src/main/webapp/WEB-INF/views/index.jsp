            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="car?brand=audi">
                        <img src="<%=request.getContextPath() %>/resources/img/logo/audi.jpg"
                             class="img-responsive" alt="audi"/>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="car?brand=volkswagen">
                        <img src="<%=request.getContextPath() %>/resources/img/logo/volkswagen.jpg"
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="car?brand=seat">
                        <img src="<%=request.getContextPath() %>/resources/img/logo/seat.jpg"
